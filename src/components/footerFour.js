                                ...
                                <div className="col-lg-4 col-12 mb-0 mb-md-4 pb-0 pb-md-2">
                                    ...
                                    <ul className="list-unstyled social-icon foot-social-icon mb-0 mt-4 d-flex align-items-center" style={{display: 'flex', alignItems: 'center', gap: '12px'}}>
                                        <li style={{display: 'flex', alignItems: 'center', margin: 0, padding: 0}}>
                                            <Link href="https://www.linkedin.com/company/afira-empowering-financial-freedom/" target="_blank" className="rounded d-inline-flex align-items-center justify-content-center" style={{width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 0, padding: 0}}>
                                        ...
                                        <li style={{display: 'flex', alignItems: 'center', margin: 0, padding: 0}}>
                                            <Link href="https://www.facebook.com/share/1Abeu9Y2KL/?mibextid=wwXIfr" target="_blank" className="rounded d-inline-flex align-items-center justify-content-center" style={{width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 0, padding: 0}}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
                                        ...
                                        <li style={{display: 'flex', alignItems: 'center', margin: 0, padding: 0}}>
                                            <Link href="https://www.instagram.com/afira_nanofinance?igsh=Z21ka3ZkemZycGZ2&utm_source=qr" target="_blank" className="rounded d-inline-flex align-items-center justify-content-center" style={{width: '32px', height: '32px', display: 'flex', alignItems: 'center', justifyContent: 'center', margin: 0, padding: 0}}>
                                                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
